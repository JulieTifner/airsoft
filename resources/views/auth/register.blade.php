            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="lastname" class="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="firstname" class="col-md-4 col-form-label text-md-end">{{ __('Vorname') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="street" class="col-md-4 col-form-label text-md-end">{{ __('Strasse') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="nr" class="col-md-4 col-form-label text-md-end">{{ __('Nr') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="birthday" class="col-md-4 col-form-label text-md-end">{{ __('Geburtsdatum') }}</label>
